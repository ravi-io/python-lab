...
# # Features: [Weather (0:Sunny, 1:Overcast, 2:Rainy), Temp (0:Hot, 1:Mild, 2:Cool)]
# X = np.array([[0, 0], [0, 1], [1, 0], [2, 1], [2, 2], [1, 2]])
...
# test_data = np.array([[0, 2], [1, 1]]) # [Sunny, Cool], [Overcast, Mild]
# predictions = clf.predict(test_data)
# print("Predictions for test data:", predictions)

from sklearn.tree import DecisionTreeClassifier

X = [[2, 4], [3, 5], [8, 25], [10, 30]]
y = [0, 0, 1, 1]
